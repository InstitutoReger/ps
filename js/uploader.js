...
! function(e) {
    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b>Clique e arraste arquivos</b></span>",
            uploadStr: "Anexar",
            abortStr: "Cancelar",
            cancelStr: "Cancelar",
            deletelStr: "Deletar",
            doneStr: "Concluído",
            multiDragErrorStr: "Envio de múltiplos arquivos não é permitido.",
            extErrorStr: "não é permitido. Extensões permitidas: ",
            duplicateErrorStr: "não é permitido. Arquivo já existe.",
